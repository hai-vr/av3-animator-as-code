...
namespace AnimatorAsCode.V1
{
    ...
    public struct AacConfiguration
    {
        ...
        public Object GetEffectiveAssetContainer()
        {
            return AssetContainer != null ? AssetContainer : GenericAssetContainer;
        }
    ...
    public class AacFlBase
    {
        ...
        {
            var allSubAssets = AssetDatabase.LoadAllAssetsAtPath(AssetDatabase.GetAssetPath(_configuration.GetEffectiveAssetContainer()));
