...
namespace AnimatorAsCode.V1
{
    internal static class AacInternals
    {
        ...
        internal static AnimationClip RegisterClip(AacConfiguration component, string suffix, AnimationClip clip)
        {
            ...
            if (component.GetPersistentAssetContainer() != null) AssetDatabase.AddObjectToAsset(clip, component.GetPersistentAssetContainer());
            return clip;
        }
        ...
        internal static T DuplicateAssetIntoContainer<T>(AacConfiguration component, T assetToDuplicate) where T : Object
        {
            ...
            if (component.GetPersistentAssetContainer() != null) AssetDatabase.AddObjectToAsset(duplicated, component.GetPersistentAssetContainer());
            return duplicated;
        }
        ...
        internal static AvatarMask NewAvatarMask(AacConfiguration component, string fullLayerName)
        {
            ...
            if (component.GetPersistentAssetContainer() != null) AssetDatabase.AddObjectToAsset(avatarMask, component.GetPersistentAssetContainer());
            return avatarMask;
        }
