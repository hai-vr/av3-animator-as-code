...
namespace AnimatorAsCode.V1
{
    internal static class AacInternals
    {
        ...
        internal static AnimationClip RegisterClip(AacConfiguration component, string suffix, AnimationClip clip)
        {
            ...
            if (component.GetEffectiveAssetContainer() != null) AssetDatabase.AddObjectToAsset(clip, component.GetEffectiveAssetContainer());
            return clip;
        }
        ...
        internal static T DuplicateAssetIntoContainer<T>(AacConfiguration component, T assetToDuplicate) where T : Object
        {
            ...
            if (component.GetEffectiveAssetContainer() != null) AssetDatabase.AddObjectToAsset(duplicated, component.GetEffectiveAssetContainer());
            return duplicated;
        }
        ...
        internal static AvatarMask NewAvatarMask(AacConfiguration component, string fullLayerName)
        {
            ...
            if (component.GetEffectiveAssetContainer() != null) AssetDatabase.AddObjectToAsset(avatarMask, component.GetEffectiveAssetContainer());
            return avatarMask;
        }
