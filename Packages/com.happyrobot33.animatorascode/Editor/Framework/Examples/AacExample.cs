...
namespace AnimatorAsCode.Framework.Examples
{
    public static class AacExample
    {
        ...
        public struct TemplateGenOptions
        {
            ...
            {
                return new TemplateGenOptions() { WriteDefaults = false };
            }
        ...
        public static void InspectorTemplate(
            Editor editor,
            SerializedObject serializedObj,
            string propName,
            Action createFn,
            Action removeFnOptional = null
        )
        {
        ...
        public static AacFlBase AnimatorAsCode(
            string systemName,
        ...
        {
            return AnimatorAsCode(
                systemName,
                avatar,
                assetContainer,
                assetKey,
                TemplateGenOptions.Defaults()
            );
        }
