...
- `void RemovePreviousParameters()` /// Remove parameter that is not used in transitions nor VRC Parameter Drivers and was created By Aac.
- `void RemoveParameter(string parameterName)` /// Remove parameter that is not used in transitions nor VRC Parameter Drivers from all animators of the Avatar descriptor.
- `void RemovePreviousLayers()` /// Remove all layers created by Aac from all animators of the Avatar descriptor.
