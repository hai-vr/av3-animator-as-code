...
- `void RemoveParameters(string parameterName)` /// Remove parameter from all animators of the Avatar descriptor. The parameter would not be removed from animator that uses it.
